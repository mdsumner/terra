...
//		std::vector<double> distLonLat(std::vector<double> x, std::vector<double> y, std::string unit, std::string method, bool transp);
		...
		bool read(std::string fname, std::string layer, std::string query, std::vector<double> ext, SpatVector filter, bool as_proxy, std::string what, std::vector<std::string> options, std::string dialect);
...
class SpatVectorCollection {
	...
	public:
		...
		bool read(std::string fname, std::string layer, std::string query, std::vector<double> extent, SpatVector filter, std::string dialect);
		
		bool read_ogr(GDALDataset *&poDS, std::string layer, std::string query, std::vector<double> extent, SpatVector filter, std::string dialect);
